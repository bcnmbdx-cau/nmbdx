...
function info($link,$pageNum = 1, $pageSize = 8)
{
    ...
    {
        $sql = "select * from information where category_id='{$_POST['category_id']}' limit $Head,$pageSize";
    }
    else
    $sql = "select * from information limit $Head,$pageSize";
...
function get_Max_Page($link)
{
    if($_POST['category_id'])
    {
        $sql = "select * from information where category_id='{$_POST['category_id']}'";
        $sql_count = "select count(*) as amount from information where category_id='{$_POST['category_id']}' ";
    }
    else
    {
        $sql = "select * from information where 1 ";
        $sql_count = "select count(*) as amount from information where 1 ";
    }
    $sql .= "order by id asc";
    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-red icon-plus-square-o" href="add.php"> 添加内容</a> </li>
 ...
 <input type='checkbox' name='id[]' value='' />{$val['id']}</td>";
                    ...
                    <td>
                        <div class='button-group'>
                            <a class='button border-blue' href='edit.php?id=<?php echo $val['id'];?>'>
